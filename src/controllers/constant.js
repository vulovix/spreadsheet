...
const gridHTML = function () {
  ...
  return `<div class="luckysheet">
                    ...
                    <div class="luckysheet-work-area luckysheet-noselected-text"> 
                        <div id ="luckysheet_info_detail" class="luckysheet_info_detail" style="display:none; height: 0; overflow:hidden;"> 
                            <div data-tips="${
                              locale_info.return
...
const iconfontObjects = {
  border: {
    ...
    "border-outside":
      " iconfont-luckysheet luckysheet-iconfont-sizhoujiabiankuang",
    "border-inside": " iconfont-luckysheet luckysheet-iconfont-neikuangxian",
    "border-horizontal":
      " iconfont-luckysheet luckysheet-iconfont-neikuanghengxian",
    "border-vertical":
      " iconfont-luckysheet luckysheet-iconfont-neikuangshuxian",
  },
  align: {
